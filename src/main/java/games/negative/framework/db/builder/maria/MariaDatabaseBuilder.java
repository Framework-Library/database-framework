...
public class MariaDatabaseBuilder {
    ...
    public MariaDatabaseBuilder(String host, int port, String database, String username, String password) {
        this.host = host;
        this.port = port;
    ...
    public MariaTableBuilder withTable(@NotNull String key) {
        return new MariaTableBuilder(this, key);
    }

    public MariaDatabaseBuilder addTable(@NotNull SQLTable table) {
        tables.add(table);
        return this;
    }
    ...
    public SQLDatabase complete() throws DriverNotFoundException, InvalidConnectionException {
        SQLDatabase mysql = new MariaDatabase(host, port, database, username, password);
